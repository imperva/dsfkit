locals {
  ...
  ) : (aws_instance.dsf_base_instance.public_ip == "" ? null : aws_instance.dsf_base_instance.public_ip)

  public_dns = var.attach_persistent_public_ip ? (
    var.eip_allocation_id != null ?
      data.aws_eip.existing[0].public_dns :
      aws_eip.dsf_instance_eip[0].public_dns
  ) : (aws_instance.dsf_base_instance.public_dns == "" ? null : aws_instance.dsf_base_instance.public_dns)
