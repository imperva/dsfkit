...
variable "aws_region_gw1" {
  type        = string
  description = "Aws region for the Agentless Gateway 1 (e.g us-east-2)"
}

variable "aws_region_gw2" {
  type        = string
  description = "Aws region for the Agentless Gateway 2 (e.g us-east-2)"
}
...
variable "subnet_gw1" {
  type        = string
  description = "Aws subnet id for the Agentless Gateway 1 (e.g subnet-xxxxxxxxxxxxxxxxx)"
}
...
variable "security_group_id_gw1" {
  type        = string
  default     = null
  description = "Aws security group id for the Agentless gateway1 (e.g sg-xxxxxxxxxxxxxxxxx). In case it is not set, a security group will be created automatically. Please refer to the readme for additional information on the deployment restrictions when running the deployment with this variable."
}

variable "security_group_id_gw2" {
  type        = string
  default     = null
  description = "Aws security group id for the Agentless gateway2 (e.g sg-xxxxxxxxxxxxxxxxx). In case it is not set, a security group will be created automatically. Please refer to the readme for additional information on the deployment restrictions when running the deployment with this variable."
}
...
variable "hub_sonarw_public_key" {
  type = string
  description = "Hub sonarw public key"
}

variable "hub_private_ip" {
  type = string
  description = "Hub private IP for communicating with the Agentless Gateways as a proxy"
}

variable "hub_ssh_user" {
  type = string
  description = "Hub ssh user for communicating with the Agentless Gateways as a proxy"
}

variable "hub_private_key_pem_file_path" {
  type = string
  description = "Hub private key file path used to ssh to the Gateway EC2s"
}
