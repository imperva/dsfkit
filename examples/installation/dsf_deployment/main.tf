...
#locals {
#  private_key_pem_file_path = var.private_key_pem_file_path != null ? var.private_key_pem_file_path : module.key_pair_hub.key_pair_private_pem.filename
#  public_key_name = var.public_key_name != null ? var.public_key_name : module.key_pair_hub.key_pair.key_pair_name
#}
