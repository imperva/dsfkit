...
output "dsf_hub_web_console" {
  value = {
    ...
    admin_password = var.web_console_admin_password_secret_name != null ? "See secret by the name of '${var.web_console_admin_password_secret_name}' in your AWS Secrets Manager" : nonsensitive(local.web_console_admin_password)
  }
}
