locals {
  ...
  hub_secondary_public_ip = var.enable_sonar && var.hub_hadr ? (length(module.hub_secondary[0].public_ip) > 0 ? format("%s/32", module.hub_secondary[0].public_ip) : null) : null
