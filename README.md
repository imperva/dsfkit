...
<table>
  ...
  <tr>
   <td>
   <a href="https://docs.imperva.com/bundle/z-kb-articles-knowledgebase-dt/page/301662213.html">Sonar v4.17</a>
  ...
  <tr>
   <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29">DSF Kit GitHub Repository</a> 
   </td>
   <td>
   </td>
  </tr>
...
Latest Supported Terraform Version: 1.7.x. Using a higher version may result in unexpected behavior or errors.
  ...
  <tr>
   <td><a href="https://github.com/imperva/dsfkit/blob/1.7.29/REQUEST_ACCESS_AWS.md">Request access to DSF installation software on AWS</a>
   </td>
   <td> Grants access for a specific AWS account to the DSF installation software.
   </td>
  </tr>
  <tr>
   <td><a href="https://github.com/imperva/dsfkit/blob/1.7.29/REQUEST_ACCESS_AZURE.md">Request access to DSF installation software on Azure</a>
   </td>
...
The following table lists the _latest_ DSF Kit releases, their release date and a high-level summary of the release's content.

[Previous releases](https://github.com/imperva/dsfkit/blob/1.7.29/PREVIOUS_RELEASES.md)
...
<table>
  ...
  <tr>
   ...
   <td>
      ...
      <br/>2. Added support for DSF version 4.13/14.13.
      <br/>3. Added support for Terraform version 1.6.x.
   </td>
  </tr>
  <tr>
   <td>24 Oct 2023
  ...
  <tr>
    ...
    <td>
      1. Added support for DSF version 4.14/14.14.
  ...
  <tr>
    ...
    <td>
      1. Moved AWS and Azure access request google forms to DSF Kit open source code.
      <br/>2. Improvements and bug fixes.
    </td>
  </tr>
 <tr>
  ...
  <tr>
    ...
    <td>
      1. Added support for DRA version 4.15.0.11 (following 4.15.0.10 recall).
    ...
    <tr>
      ...
      <td>
        1. Dropped support for DRA version 4.14.* in DSF Kit due to a bug.
    ...
    <tr>
      ...
      <td>
        1. Fixed a bug in Azure mx module when using a private IP.
        <br/>2. Added a DRA readiness timeout.
  ...
  <tr>
    ...
    <td>
      Added support for Terraform version 1.12.x.
    </td>
  </tr>
...
3. Latest Supported Terraform Version: 1.12.x. Using a higher version may result in unexpected behavior or errors.
4. [jq](https://jqlang.github.io/jq/) - Command-line JSON processor.
5. [curl](https://curl.se/) - Command-line tool for transferring data.

### AWS Prerequisites

1. Create an AWS User with secret and access keys which comply with the required IAM permissions (see [IAM Permissions for Running DSF Kit section](#iam-permissions-for-aws)).
2. The deployment requires access to the DSF installation software. [Click here to request access](https://github.com/imperva/dsfkit/blob/1.7.29/REQUEST_ACCESS_AWS.md).
...
1. [Establish an Azure App Registration](https://learn.microsoft.com/en-us/azure/healthcare-apis/register-application) and [assign it a custom role](https://learn.microsoft.com/en-us/azure/role-based-access-control/role-assignments-portal?tabs=delegate-condition) (without role assignment conditions) 
   under the associated subscription, ensuring the custom role includes the required IAM permissions (see [IAM Permissions for Running DSF Kit section](#iam-permissions-for-azure)).
2. The deployment requires access to the DSF installation software. [Click here to request access](https://github.com/imperva/dsfkit/blob/1.7.29/REQUEST_ACCESS_AZURE.md).
...
These examples can be found in the <a href="https://github.com/imperva/dsfkit/tree/1.7.29">DSF Kit GitHub Repository</a> under the <a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples">examples</a> directory.
...
<table>
   <tr>
     ...
     <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/installation/dsf_single_account_deployment/README.md">DSF Single Account Deployment</a>
      </td>
      <td>PS/Customer
      </td>
      ...
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/installation/dsf_single_account_deployment/dsf_single_account_deployment_1_7_29.zip">dsf_single_account_deployment_1_7_29.zip</a>
      </td>
   </tr>
     <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/poc/dsf_deployment/README.md">DSF Deployment</a>
      </td>
      <td>Lab/POC
      </td>
      ...
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/poc/dsf_deployment/dsf_deployment_1_7_29.zip">dsf_deployment_1_7_29.zip</a>
      </td>
   </tr>
     <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/installation/sonar_single_account_deployment/README.md">Sonar Single Account Deployment</a>
      </td>
      <td>PS/Customer
      </td>
      ...
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/installation/sonar_single_account_deployment/sonar_single_account_deployment_1_7_29.zip">sonar_single_account_deployment_1_7_29.zip</a>
      </td>
   </tr>
   <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/installation/sonar_multi_account_deployment/README.md">Sonar Multi Account Deployment</a>
      </td>
      <td>PS/Customer
      </td>
      ...
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/installation/sonar_multi_account_deployment/sonar_multi_account_deployment_1_7_29.zip">sonar_multi_account_deployment_1_7_29.zip</a>
      </td>
   </tr>
   <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/poc/sonar_basic_deployment/README.md">Sonar Basic Deployment</a>
      </td>
      <td>Lab/POC
      </td>
      <td>A DSF deployment with a DSF Hub, an Agentless Gateway, federation, networking and onboarding of a MySQL DB. 
      </td>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/poc/sonar_basic_deployment/sonar_basic_deployment_1_7_29.zip">sonar_basic_deployment_1_7_29.zip</a>
      </td>
   </tr>
   <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/poc/sonar_hadr_deployment/README.md">Sonar HADR Deployment</a>
      </td>
      <td>Lab/POC
      </td>
      ...
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/poc/sonar_hadr_deployment/sonar_hadr_deployment_1_7_29.zip">sonar_hadr_deployment_1_7_29.zip</a>
      </td>
   </tr>
   <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/sonar_upgrade/README.md">Sonar Upgrade</a>
      </td>
      <td>All
      </td>
      <td>Upgrade of DSF Hub and Agentless Gateway (formerly Sonar).
      </td>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/sonar_upgrade/sonar_upgrade_1_7_29.zip">sonar_upgrade_1_7_29.zip</a>
      </td>
   </tr>
</table>
...
<table>
  ...
  <tr>
     <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/azure/poc/dsf_deployment/README.md">DSF Deployment</a>
     </td>
     <td>Lab/POC
     </td>
     ...
     <td><a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/azure/poc/dsf_deployment/dsf_deployment_1_7_29.zip">dsf_deployment_1_7_29.zip</a>
     </td>
  </tr>
</table> 
...
When using DSF Kit, there is no need to manually download the DSF installation software, DSF Kit will do that automatically based on the Sonar, DAM and DRA versions specified in the Terraform example.
...
1. Download the zip file of the example you've chosen (See the [Choosing the Example/Recipe that Fits Your Use Case](#choosing-the-examplerecipe-that-fits-your-use-case) section) from the <a href="https://github.com/imperva/dsfkit/tree/1.7.29">DSF Kit GitHub Repository</a>, e.g., if you choose the "dsf_deployment" example, you should download <a href="https://github.com/imperva/dsfkit/raw/1.7.29/examples/aws/poc/dsf_deployment/dsf_deployment_1_7_29.zip">dsf_deployment.zip</a>.
...
6. In the “Advanced details” panel, copy and paste the contents of this [bash script](https://github.com/imperva/dsfkit/blob/1.7.29/installer_machine/installer_machine_user_data.sh) into the [User data](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/user-data.html) textbox.
...
9. Download the zip file of the example you've chosen (See the [Choosing the Example/Recipe that Fits Your Use Case](#choosing-the-examplerecipe-that-fits-your-use-case) section) from the <a href="https://github.com/imperva/dsfkit/tree/1.7.29">DSF Kit GitHub Repository</a>, e.g., if you choose the "dsf_deployment" example, you should download <a href="https://github.com/imperva/dsfkit/raw/1.7.29/examples/aws/poc/dsf_deployment/dsf_deployment_1_7_29.zip">dsf_deployment.zip</a>.
    Run:
    ```bash
    wget https://github.com/imperva/dsfkit/raw/1.7.29/examples/aws/installation/dsf_single_account_deployment/dsf_single_account_deployment_1_7_29.zip

    or

    wget https://github.com/imperva/dsfkit/raw/1.7.29/examples/aws/poc/dsf_deployment/dsf_deployment_1_7_29.zip

    or
 
    wget https://github.com/imperva/dsfkit/raw/1.7.29/examples/aws/installation/sonar_single_account_deployment/sonar_single_account_deployment_1_7_29.zip

    or
 
    wget https://github.com/imperva/dsfkit/raw/1.7.29/examples/aws/installation/sonar_multi_account_deployment/sonar_multi_account_deployment_1_7_29.zip    

    or

    wget https://github.com/imperva/dsfkit/raw/1.7.29/examples/aws/poc/sonar_basic_deployment/sonar_basic_deployment_1_7_29.zip

    or
    
    wget https://github.com/imperva/dsfkit/raw/1.7.29/examples/aws/poc/sonar_hadr_deployment/sonar_hadr_deployment_1_7_29.zip        
    ```
...
2. **Create a new workspace:** Complete these steps to create a new workspace in Terraform Cloud that will be used for the DSF deployment. 
    ...
    * Click “Create workspace” to finish and save the new DSF Kit workspace.<br>![Create workspace](https://user-images.githubusercontent.com/52969528/212977895-ad9cdc4c-bf44-4a83-b67e-57e7f7e6e6f7.png)

3. **Add the AWS variables:** The next few steps will configure the required AWS variables.
    * Once the DSF Kit workspace is created, click the "Go to workspace overview" button.<br>![Go to Workspace Overview](https://user-images.githubusercontent.com/52969528/212978246-42ce66c1-ffbc-4932-8c0a-4d13188065eb.png)
...
1. The upgrade requires access to the DSF installation software. [Click here to request access](https://github.com/imperva/dsfkit/blob/1.7.29/REQUEST_ACCESS_AWS.md).
...
5. Latest Supported Terraform Version: 1.12.x. Using a higher version may result in unexpected behavior or errors.
...
1. Download the zip file of the Sonar upgrade example: <a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/sonar_upgrade/sonar_upgrade_1_7_29.zip">sonar_upgrade_1_7_29.zip</a>.
...
4. Enter the details of DSF Hubs and Agentless Gateways which you want to upgrade, and the desired configuraiton options, in the <a href="https://github.com/imperva/dsfkit/blob/1.7.29/examples/aws/sonar_upgrade/main.tf">main.tf</a> file.
...
6. In the “Advanced details” panel, copy and paste the contents of this [bash script](https://github.com/imperva/dsfkit/blob/1.7.29/installer_machine/upgrade_installer_machine_user_data.sh) into the [User data](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/user-data.html) textbox.
...
Use the <a href="https://github.com/imperva/dsfkit/tree/1.7.29/modules/aws/sonar-upgrader/python_upgrader/README.md">Python Upgrader</a> utility.

# More Information

Information about additional topics can be found in specific examples, when relevant.

For example:  <a href="https://github.com/imperva/dsfkit/tree/1.7.29/examples/aws/installation/sonar_single_account_deployment/README.md">Sonar Single Account Deployment</a>
