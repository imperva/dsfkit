...
<table>
  ...
  <tr>
   <td><a href="https://github.com/imperva/dsfkit/tree/1.4.0">DSFKit GitHub Repository</a> 
   </td>
   <td>
   </td>
  </tr>
...
Latest Supported Terraform Version: 1.4.0. Using a higher version may result in unexpected behavior or errors.
  ...
  <tr>
   ...
   <td>Grants access for a specific e-mail address to Imperva's Terraform Cloud account.
       Required for <a href="https://github.com/imperva/dsfkit/tree/1.4.0#terraform-cloud-deployment-mode">Terraform Cloud Deployment Mode</a>
   </td>
  </tr>
  <tr>
...
These examples can be found in the <a href="https://github.com/imperva/dsfkit/tree/1.4.0">DSFKit GitHub Repository</a> under the <a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples">examples</a> directory.
...
<table>
   ...
   <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/poc/basic_deployment/README.md">Basic Deployment</a>
      </td>
      <td>Lab/POC
      </td>
      <td>A DSF deployment with a DSF Hub, an Agentless Gateway, federation, networking and onboarding of a MySQL DB. 
      </td>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/poc/basic_deployment/basic_deployment.zip">basic_deployment.zip</a>
      </td>
   </tr>
   <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/poc/hadr_deployment/README.md">HADR Deployment</a>
      </td>
      <td>Lab/POC
      </td>
      ...
      <td><a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/poc/hadr_deployment/hadr_deployment.zip">hadr_deployment.zip</a>
      </td>
   </tr>
   <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/installation/single_account_deployment/README.md">Single Account Deployment</a>
      </td>
      <td>PS/Customer
      </td>
      ...
      <td><a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/installation/single_account_deployment/single_account_deployment.zip">single_account_deployment.zip</a>
      </td>
   </tr>
   <tr>
      <td><a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/installation/multi_account_deployment/README.md">Multi Account Deployment</a>
      </td>
      <td>PS/Customer
      </td>
      ...
      <td><a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/installation/multi_account_deployment/multi_account_deployment.zip">multi_account_deployment.zip</a>
      </td>
   </tr>
</table>
...
1. Download the zip file of the example you've chosen (See the [Choosing the Example/Recipe that Fits Your Use Case](#choosing-the-examplerecipe-that-fits-your-use-case) section) from the <a href="https://github.com/imperva/dsfkit/tree/1.4.0">DSFKit GitHub Repository</a>, e.g., if you choose the "basic_deployment" example, you should download <a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/poc/basic_deployment/basic_deployment.zip">basic_deployment.zip</a>.
...
11. Download the zip file of the example you've chosen (See the [Choosing the Example/Recipe that Fits Your Use Case](#choosing-the-examplerecipe-that-fits-your-use-case) section) from the <a href="https://github.com/imperva/dsfkit/tree/1.4.0">DSFKit GitHub Repository</a>, e.g., if you choose the "basic_deployment" example, you should download <a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/poc/basic_deployment/basic_deployment.zip">basic_deployment.zip</a>.
    Run:
    ```bash
    wget https://github.com/imperva/dsfkit/raw/1.4.0/examples/poc/basic_deployment/basic_deployment.zip
    
    or
    
    wget https://github.com/imperva/dsfkit/raw/1.4.0/examples/poc/hadr_deployment/hadr_deployment.zip
    
    or
 
    wget https://github.com/imperva/dsfkit/raw/1.4.0/examples/installation/single_account_deployment/single_account_deployment.zip
    
    or
 
    wget https://github.com/imperva/dsfkit/raw/1.4.0/examples/installation/multi_account_deployment/multi_account_deployment.zip
    ```
...
For example:  <a href="https://github.com/imperva/dsfkit/tree/1.4.0/examples/installation/single_account_deployment/README.md">Single Account Deployment</a>
